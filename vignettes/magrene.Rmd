...
img <- system.file("extdata", "motifs_vignette.png", package = "magrene")
...
# Keep only the top 10k edges of the GRN, remove "Weight" variable
grn <- gma_grn[1:10^4, 1:2]
```
...
```{r delta}
delta <- find_delta(grn, paralogs, gma_ppi)
head(delta)
```
